                ...
                child: Column(
                  children: [
                      ...
                      AuthInputForm(
                        ...
                        onChange: (value) {
                          setState(() {
                            ...
                            _authForm.fullNameValid =
                                AuthForm.validateFullname(value) == null;
                          });
                        },
                        validator: (value) {
                          if (isSignUp) {
                    ...
                    AuthInputForm(
                      ...
                      onChange: (value) {
                        setState(() {
                          ...
                          _authForm.emailValid =
                              AuthForm.validateEmail(value) == null;
                        });
                      },
                    ...
                    AuthInputForm(
                      ...
                      validator: (value) {
                        String? password =
                            AuthForm.validatePassword(value ?? '');
                        if (password != null) {
                          return password;
                        }
